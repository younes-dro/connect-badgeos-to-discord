...
class Connect_Badgeos_To_Discord_Activator {
	...
	public static function activate() {
		...
		update_option( 'ets_badgeos_discord_deduct_user_points_message', 'Ops [GP_USER_NAME]([GP_USER_EMAIL])! You lost [GP_DEDUCT_POINTS] [GP_POINTS_TYPE] for [GP_POINTS_LABEL] Your new [GP_POINTS_TYPE] balance is: [GP_POINTS_BALANCE], [SITE_URL], [BLOG_NAME]' );
